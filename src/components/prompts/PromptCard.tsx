...
export function PromptCard({ prompt, showRating = false, userId: externalUserId, onCopy, folders, currentFolderId, onMoveToFolder, onCreateFolder, savedPromptId, onSaveChange }: PromptCardProps) {
  ...
  return (
    <div className="bg-white dark:bg-dark-card rounded-2xl p-6 flex flex-col h-full border border-apple-gray-200 dark:border-dark-border hover:shadow-md transition-shadow duration-300">
      {/* Header */}
      <div className="flex items-start justify-between gap-4 mb-4">
        ...
        {userId ? (
          <button
            onClick={handleSave}
            disabled={saving}
            className="text-apple-gray-400 hover:text-apple-blue transition-colors disabled:opacity-50"
