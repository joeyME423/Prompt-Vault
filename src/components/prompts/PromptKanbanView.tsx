        ...
        return (
          <div key={category} className="min-w-[280px] max-w-[320px] flex-shrink-0">
            ...
            <div className="flex items-center gap-2 mb-3 px-1">
              ...
              <span className="text-xs text-apple-gray-400 dark:text-slate-500">
...
function KanbanCard({ prompt }: { prompt: Prompt }) {
  ...
  return (
    <div className="bg-white dark:bg-dark-card rounded-2xl border border-apple-gray-200 dark:border-dark-border p-4">
      <h4 className="text-sm font-semibold text-apple-black dark:text-white mb-1.5">
        {prompt.title}
      </h4>
      <p className="text-xs text-apple-gray-400 dark:text-slate-400 line-clamp-2 mb-3">
        {prompt.description}
      </p>
        ...
        <button
          ...
          className={`flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium transition-colors ${
            copied
              ...
              : 'bg-apple-gray-50 dark:bg-dark-hover text-apple-gray-500 dark:text-slate-400 hover:bg-apple-blue hover:text-white'
          }`}
        >
